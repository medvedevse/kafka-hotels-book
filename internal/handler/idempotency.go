...
func NewIdempotentHandler(redisAddr string) (*IdempotentHandler, error) {
...
func (h *IdempotentHandler) HandlerMessage(msg []byte) error {
...
func (h *IdempotentHandler) extractMessageKey(msg []byte) (string, error) {
...
func (h *IdempotentHandler) hashMessage(msg []byte) string {
	hash := sha256.Sum256(msg)
	return hex.EncodeToString(hash[:])
}

func (h *IdempotentHandler) Close() error {
